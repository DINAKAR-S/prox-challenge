...
source: owner-manual
page: 31
topics: [tig-welding-technique, optional-settings, strike-test, ctwd-tig, shutdown, tig-rod, foot-pedal]
---

# Page 31 (Item 57812) — TIG Welding: Optional Settings and Technique

Sidebar tabs (right edge): Safety, Controls, Wire, TIG / STICK (active), Welding Tips, Maintenance.
...
> **Callout box:** After practice welding on scrap, stop, and check your progress. Perform Strike Test according to Strike Test on page 34. After making any necessary adjustments, continue to weld while carefully following the DUTY CYCLE guidelines as explained on page 29.

### WARNING! TO PREVENT SERIOUS INJURY:
> Metal work bench must be grounded when TIG welding.
...
### Figure: Recall Setting screen (upper left)
Black LCD screen mock-up: title "Recall Setting" with an upward-arrow-into-tray icon below it. Bottom icon row of two icons, the first (Recall) highlighted/inverted.

### Figure: Save Setting screen (below Recall Setting figure)
Black LCD screen mock-up: title "Save Setting" with a downward-arrow-into-tray icon below it. Bottom icon row of two icons, the second (Save) highlighted/inverted.

No other diagrams on this page; the remainder is numbered procedural text (steps 10–19) for hand-holding technique, arc starting, puddle/rod technique, and shutdown/storage checklist.
