...
source: owner-manual
page: 3
topics: [safety, fume-and-gas-safety, arc-ray-safety]
---

# Page 3 — Fume and Gas Safety / Arc Ray Safety
...
### Figure: Fume/Gas hazard icon
Pictogram of a person's head/torso with a gas-mask style respirator, next to a triangular hazard icon showing a stick figure inhaling rising fumes with an exclamation point — corresponds to the "Inhalation Hazard" symbol defined on page 6.

### Figure: Arc Ray hazard icon
Triangular hazard icon showing a welder's head in a welding helmet with radiating arc rays striking the face — corresponds to the "Arc Ray Hazard" symbol defined on page 6.

Item 57812 | For technical questions, please call 1-800-444-3353. | Page 3
